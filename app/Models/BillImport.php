...
class BillImport
{
    ...
    public $shortname;
    public $bill;
    public $structure = ['section', 'subsection', 'paragraph', 'subparagraph', 'clause', 'subclause', 'item'];
    public $text_tags = ['enum', 'header', 'text'];
    ...
    {
        $this->slug = strtolower(urlencode(str_replace([' ', '.'], ['-', ''], $this->title)));
