...
<div class="container">
  <div class="row" ng-controller="DashboardEditorController" ng-init="init()">
    <div class="col-md-12">
      ...
      <a href="{{ route('docs.doc', $doc->slug) }}" style="float:right" class="public-link" target="_self"><span class="glyphicon glyphicon-eye-open"></span> {{ trans('messages.publicview') }}</a>
                ...
                <form class="form-horizontal">
                  ...
                  <div class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" data-target="#">
                      @{{ date.date | parseDate | date:'short' }}
                    </a>
